...
import 'package:boarding_house_management/features/profile/screens/account_setup_screen.dart';
...
//------------------------------------------------------------------------------signin with google
  Future<String?> signInWithGoogle(BuildContext context) async {
    try {
      ...
      print("Acount ....: "+googleAuth.toString());

      final credential = GoogleAuthProvider.credential(
          accessToken: googleAuth?.accessToken, idToken: googleAuth?.idToken);
      print("Credintial  ....: "+credential.toString());
      userCredentialGoogle = await _auth.signInWithCredential(credential);
    //  print("User Credintial  ....: "+userCredential.toString());
     print("User Credintial  ....: "+userCredentialGoogle.toString());
      notifyListeners();

      // ignore: unnecessary_null_comparison
      if (userCredentialGoogle != null) {
        print("userCredentialGoogle not empty .....");
        ...
        return null;
                ...
                print("userCredentialGoogle is empty .....");
